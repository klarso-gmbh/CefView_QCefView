...
public:
  ...
  /// <param name="findNext">set true to continue last search</param>
  void findText(const QString& text, bool forward = true, bool matchCase = false, bool findNext = false);
...
signals:
  ...
  /// Gets called with results to searches started via <see cref="findText"/>
  /// </summary>
  /// <param name="browserId">The browser id</param>
  /// <param name="findId">The findId that was generated by <see cref="findText"/></param>
  /// <param name="count">The result count</param>
  /// <param name="selectionRect">The selection of the match</param>
  /// <param name="activeMatchOrdinal">Index of the match</param>
  /// <param name="finalUpdate">true if last match</param>
  void findResult(int browserId, int findId, int count, const QRect& selectionRect, int activeMatchOrdinal, bool finalUpdate);
